    ...
    <div className="p-6 lg:p-8 max-w-full mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl border shadow-sm p-6 space-y-4">
        ...
        <div className="grid grid-cols-4 gap-4 text-center text-sm font-bold">
            ...
            <div className="p-2 bg-green-50 rounded text-green-800"><p className="font-normal text-xs">Actual</p>
        ...
        <div className="overflow-x-auto max-h-96">
            <table className="w-full text-xs">
                <thead className="bg-gray-100 sticky top-0"><tr>
                    <th className="p-2 text-left">Product</th><th className="p-2 text-center">Op</th><th className="p-2 text-center">Purch</th><th className="p-2 text-center">Sales</th>
                    <th className="p-2 text-center font-bold text-blue-700 bg-blue-50">Exp</th><th className="p-2 text-center font-bold text-green-700 bg-green-50">Actual</th><th className="p-2 text-center font-bold text-red-700 bg-red-50">Var</th>
                </tr></thead>
                ...
                {stockRows.map(r => (
                    <tr key={r.productId} className="hover:bg-gray-50">
                        ...
                        <td className="p-1 bg-green-50"><input type="number" value={r.actual} onChange={(e) => handleActualChange(r.productId, e.target.value)} className="w-full p-1 border rounded text-center font-bold" /></td>
