...
const navigation = [
  ...
  { name: "Profit & Loss", href: "/reports/profit-loss", icon: ScaleIcon }, // NEW LINK
  { name: "Stock Return", href: "/reports/stock", icon: DocumentIcon },
...
export function Sidebar() {
  ...
  // Re-check shift status whenever the URL (pathname) changes
  useEffect(() => {
  ...
  const handleCashConfirm = async (amount: number, notes?: string) => {
    ...
    if (shiftMode === 'open') {
      ...
      // Redirect to Stock Return page for closing
